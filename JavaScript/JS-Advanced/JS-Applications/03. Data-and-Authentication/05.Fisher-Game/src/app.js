...
async function onUpdate(id, updatedCatch) {
...
function createPreview(c) {
    ...
    const element =
        e('div', { className: 'catch' },
            e('label', {}, 'Angler'),
            e('input', { type: 'text', disabled: `${!isOwner ? 'true' : 'false'}`, className: 'angler', value: `${c.angler}` }),
            e('hr', {}),
            e('label', {}, 'Weight'),
            e('input', { type: 'number', disabled: `${!isOwner ? 'true' : 'false'}`, className: 'weight', value: `${c.weight}` }),
            e('hr', {}),
            e('species', {}, 'Species'),
            e('input', { type: 'text', disabled: `${!isOwner ? 'true' : 'false'}`, className: 'species', value: `${c.species}` }),
            e('hr', {}),
            e('label', {}, 'Location'),
            e('input', { type: 'text', disabled: `${!isOwner ? 'true' : 'false'}`, className: 'location', value: `${c.location}` }),
            e('hr', {}),
            e('label', {}, 'Bait'),
            e('input', { type: 'text', disabled: `${!isOwner ? 'true' : 'false'}`, className: 'bait', value: `${c.bait}` }),
            e('hr', {}),
            e('label', {}, 'Capture Time'),
            e('input', { type: 'number', disabled: `${!isOwner ? 'true' : 'false'}`, className: 'captureTime', value: `${c.captureTime}` }),
            e('hr', {}),
            updateBtn,
            deleteBtn
        );
...
function isAuthenticated(isAuth) {
    ...
    if (isAuth != null) {
        ...
        guestSpan.textContent = sessionStorage.getItem('userEmail');
