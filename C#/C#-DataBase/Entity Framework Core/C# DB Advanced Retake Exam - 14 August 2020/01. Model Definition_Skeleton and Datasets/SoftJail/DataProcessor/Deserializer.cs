namespace SoftJail.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        public static string ImportPrisonersMails(SoftJailDbContext context, string jsonString)
        {
            ...
            foreach (var currentPrisoner in prisonerMails)
            {
                ...
                var isValidReleaseDate = DateTime
                    .TryParseExact(currentPrisoner.ReleaseDate, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime releaseDate);
        ...
        public static string ImportOfficersPrisoners(SoftJailDbContext context, string xmlString)
        {
            ...
            var officerPrisoners = XmlConverter.Deserializer<OfficerPrisonerInputModel>(xmlString, root);
